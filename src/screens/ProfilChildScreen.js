...
const profil= require("../../assets/images/babyprofile.png");
const nomLogo = require("../../assets/images/id-card.png");
const idLogo = require("../../assets/images/id-card.png");
const dnLogo = require("../../assets/images/birthday.png");
const mother = require("../../assets/images/mother.png");
const father = require("../../assets/images/father.png");
const finger=require("../../assets/images/fingerprint.png")
      ...
      <View style={styles.topSection} className="flex-1 bg-white">
        ...
        <TouchableOpacity style={styles.buttonSection} activeOpacity={0.9}>
          ...
          <View style={styles.iconArea}>
            <Image source={finger} style={styles.iconStyle} resizeMode="contain" />
          </View>
          <Text style={styles.buttonName}>Enf-12345678</Text>
          </View>
        ...
        <TouchableOpacity style={styles.buttonSection} activeOpacity={0.9}>
          ...
          <Text style={styles.buttonName}>EL KORTI Alae</Text>
          </View>
          <View style={styles.sp}></View>
        </TouchableOpacity>
        ...
        <TouchableOpacity style={styles.buttonSection} activeOpacity={0.9}>
          <View style={styles.buttonArea}>
          <View style={styles.iconArea}>
            <Image source={dnLogo} style={styles.iconStyle} resizeMode="contain" />
          </View>
          <Text style={styles.buttonName}>2020-06-02</Text>
          </View>
          <View style={styles.sp}></View>
        </TouchableOpacity>
        ...
        {/* <TouchableOpacity style={styles.buttonSection} activeOpacity={0.9}>
          <View style={styles.buttonArea}>
          <View style={styles.iconArea}>
            <Image source={mother} style={styles.iconStyle} resizeMode="contain" />
          </View>
          <Text style={styles.buttonName}>Mother name</Text>
          </View>
        </TouchableOpacity> */}
        </View>
